...
namespace Vaultopia.Web.Controllers {
    public class ArticleController : PageController<Article> {
        ...
        public string RenderMedia(MediaReference mediaReference) {
            ...
            return media != null ? media.Html : string.Empty;
        }
