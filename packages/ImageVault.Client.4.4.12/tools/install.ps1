...
Function UpdateBindingRedirect([System.IO.FileInfo] $file, [System.Xml.XmlElement[]] $assemblyConfigs) {
	...
	Write-Host "Setting redirect to $assemblyName.Version"
}
...
if((test-path $configPath)) {
	...
	$assemblyConfigs = $config.configuration.runtime.assemblyBinding.dependentAssembly
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGqhZoxbZoFOkmj7L7Ive/byw
# yhWgghQTMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# FCEVAAU0IdHNSkk0ewit0uecq5JMMA0GCSqGSIb3DQEBAQUABIIBAKInJk+CvQ9/
# mAAAgye1Z1hDl5BFSTuceW7VYzY3UX3KUSbaPVksrgSiePtYF2NEW66nPoyV6PvE
# HBcuTgeSqRQvalUIDTGTL0s36sy0NK9QF6zETpmPWqkrXGTtxUXIyBGiLx8L1sjE
# CL8mcYSL/bbs6XBCwPC+erkiUvf1DfqOBGtsmb9yxTABfOWrRnrZY39I95iWPmFz
# vxAiNRG7X2cp1NKHe6boGtGjxOcctoM1dDXpHwMxNDfmKB9zmBrFSWhE662ovJnY
# Brc6tkVOHRnTxITUOpxTpuwYc61sa+QcHMlAnzQLF3CiPJ7xA8rIFqqEXQa/KT6W
# qW1jk28NvbehggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQswCQYD
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTQwMjE2MDEwMTAyWjAjBgkqhkiG9w0BCQQxFgQU
# BmV5aPvsqBxWycBKQ6xLzt2sTB4wDQYJKoZIhvcNAQEBBQAEggEALMxp3S668bKC
# SprIkRkIkSSdMnAL7YSuF2MEz/UnJdOsWu37F1lABvv1tH7uPTbpjGO2a4NJE7d/
# Ola8VWX+/kASa2H7Zkw8xRlAmQzBlqIWTxfFewfWU96oduUfBaOhybTRO+hBJLJW
# FQ2uUqR99+l37uy10TV5bIiIBR2xFCUHEmKyFFxNz875DnlpyhL+BLpWA0AVHFIH
# aSUP3xB/Ul2SdG+4sxwzH/bH91gt+5jI8ukptXJvObFNIHUaffO+BDisX8NagA2Q
# /CUZ/NdvcsFHnXlmdKk3VkXadrO56pNdDqnAtb4JGHaOwpCHEVxUNw3x+9dQkSh3
# dcM9Ouz6Qw==
