...
# Returns the XmlDocument loaded from the web.config and connected configSource files present at given project path
# $projectPath path to the project file 
# $configSourcesToBeLoaded array of elementNames which need to be loaded through their configSource path. Default is null which means load all 
Function Get-WebConfig($projectPath, [string[]]$configSourcesToBeLoaded)
{   
	$filePath = Join-Path $projectPath "web.config"
	...
	$webConfig = Get-XmlDocument $filePath
	...
	$webConfig.SelectNodes("//*[@configSource]") | ForEach-Object {
		...
		# if configSources are given then only load those ones, otherwise load everything
		$currentElementName = $_.Name		 
		if($configSourcesToBeLoaded -eq $null -or $configSourcesToBeLoaded.Length -lt 1 -or $configSourcesToBeLoaded -contains $currentElementName) 
		{			
			...
			if (Test-Path $configFragmentPath)
			{
				...
				$referencedElement = (Get-XmlDocument $configFragmentPath).FirstChild
				if($referencedElement -ne $null -and $referencedElement -ne "")
				{
					$_.InnerXml = $referencedElement.InnerXml
				}			
			}
		}		
	}
...
# returns an xmldocument from the given path
Function Get-XmlDocument($filePath)
{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIw8wGuH1+A3lsK2NqTrDP9Go
# Y+GgghLKMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUZNI+NdJW
# d4juVveCB/N9P39DptYwDQYJKoZIhvcNAQEBBQAEggEAKJNnRhfvOaS4ZGtTu2Zt
# SxoA3mqmxAJVnSf5KC6euwQHpV3ukICtO0kTXl/4UEzVa4DXzcysyB8/HfJyTEKU
# v4q5q8Lw1106hJfDEJSg1i5w4Cu0PwnC3ENfYfRuWMvCxx9egBTKKbZK2YsMh60P
# saQrSJHbLzuHU+30LjJxTfnYaVEysSkfOecR4v3h0l2UYVGhvv7qRIYTBHI+UoFq
# dE7y2PBFjNL0fb196ZkbQCQzyr8t7kanTZ6qQFJjjlxJamzUxXmXN8BLrwJskD4y
# ByV6UHTrp5Hs9NSjLpY8TbFWXo+5GaBlF3uF2y9wExKADdQgc0TrX/HG931gNB56
# raGCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIBATByMF4xCzAJBgNVBAYTAlVT
...
# SIb3DQEJBTEPFw0xNjA1MTMxMzA4MDBaMCMGCSqGSIb3DQEJBDEWBBQ3jV7V1AgH
# AXZ+Fiz9f8kE7sQtqjANBgkqhkiG9w0BAQEFAASCAQA0z6afoldfx8lUF+GIC3+B
# tHYoEYuG+N50fNG03p2gNVDX43vVUtd+7joHuV3J8t1SjtqkW0pRdXaowhQw0L1l
# GcdXD5fOmDcL+sMqepbPBAEtEtY6tB+4o1uVpCP27ty1dNURuiSOGKo0xOPOcuE5
# Vs24tWFvzUifJGQANVfuLFlNFmimshBbFVWlx0bm5D/sduR6q4g/1Siq9wHsSrLX
# 5GiWQ7APDr/sgCtAuoxra8pfCOTsTRz9rkoA/7VpqxfvLCsqKuCJqTYr5pBiWJQ4
# NQxM1omKVOJOc3E8tLsSkWxcU8NozHTFNltefz8SNOrYzuTqyfz1WTC5sk+Aplj+
