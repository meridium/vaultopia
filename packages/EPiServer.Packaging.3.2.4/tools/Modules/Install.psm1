...
Import-Module "$EPiServerPackagingScripts\Remove-EPiServerAddOn.psm1"
Import-Module "$EPiServerPackagingScripts\Set-AssemblyBinding.psm1"


function Update-EPiServerSite 
{
    param($installPath, $toolsPath, $projectPath)

    Remove-EPiServerAddOn "EPiServer.Packaging" $projectPath @("EPiServer.Packaging.dll", "EPiServer.Packaging.CmdApi.dll", "Nuget.Core.dll")

    Remove-EPiServerAddOn "EPiServer.Packaging.UI" $projectPath @("EPiServer.Packaging.UI.dll")
    ...
    $configBaselinePath =[System.IO.Path]::Combine($installPath, "tools\webconfig-baseline.config")
    $sitePath = $projectPath
    $epideployPath = Join-Path $fxTools 'epideploy.exe'

    Set-AssemblyBinding $installPath $projectPath

	& $epideployPath -s $sitePath -a config -p $configBaselinePath
}

Export-ModuleMember -Function Update-EPiServerSite
# SIG # Begin signature block
# MIIXnAYJKoZIhvcNAQcCoIIXjTCCF4kCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUq3gLxxaUI5v/8rjaWZFkak7R
# uSCgghLKMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUu+l2tqA/
# BbbDJ+T1fdLY/d85PqcwDQYJKoZIhvcNAQEBBQAEggEAo0BWZGCIZm8RLJfrZf3Y
# 5Tn+3105Ggd0+WcfIe+f0pFhzF5QmPMzlLs/rMIOD415nE9MyhevY17E4T+TURT6
# xCxWE1S/TagBLlG9ZnzQyc/WXuknTojK7XrYKbZc6Me1SPz8qycWkXxmgs+iHjtN
# TlkHhenaoAN4ZSwMy2acsaDACWVw7eJnbJYVIGrqggvcQ862zZeY7LY9GrknWq0I
# KlomFMMsO0cAy8vU1JDkT8pl0VbV0LgxxTYZaCtvJn5OHD8bAxd4KobXnvhLPbWw
# J5Ve6qMtvJNrkn/mkKbwxCAJMIEr2FoKq16ZhzOynTIs9y2sS5wWPWFUmLKVjcai
...
# SIb3DQEJBTEPFw0xNjA1MTMxMzA4MDJaMCMGCSqGSIb3DQEJBDEWBBSzRcbL28uO
# 6DFyFcRwgpiArGjM3DANBgkqhkiG9w0BAQEFAASCAQBC+uys3RH+Ny/3JnglpIs8
# T6ts3cSzViJNmts0LWZ+DT/asoO7T2C5IXb6Op3H96HUCkFvFKVvvmGC//BEsis8
# FW05LulFyCZbwuzb2NVXZZrq8W84OWlOqfMMaiCQ+hy85ZpTTCVXelLN9g0CdsOc
# 3vFBt9EcGXUYEJ6YrOSxiZ2HWj6oUh1zfOWqyiv/MCvqkJuvlIxS0dDe8OgZ+oqn
# TrHyNMK73HaIglBN4F5HmTnI2WIEk1iBjoJDyexmblP+GnaKxcFiL5TWIL+bimbg
# sqMyIttxQYaa96iD89wFyDMe96hYCzORa/oTW/xQhGdxia+UKowG+TXdsjIj2gMp
