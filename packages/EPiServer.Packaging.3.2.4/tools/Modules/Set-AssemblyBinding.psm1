...
##
Function Set-AssemblyBinding($installPath, $projectPath)
{      
    try 
    {
        $elementsToBeLoaded = (,"runtime")
    ...
    catch [Exception]
    {
        ...
        Write-Host "Writing assembly binding information failed due to an error. Error message:- $ErrorMsg"
    }   
}
...
Export-ModuleMember -Function Set-AssemblyBinding, Get-FileName, Get-AssemblyName
# SIG # Begin signature block
# MIIXnAYJKoZIhvcNAQcCoIIXjTCCF4kCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfdt6aJUwuOP4oVNmHp1XXxaY
# rsSgghLKMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUmDvFKrt2
# aV/cmkiefJNOuvGFiyQwDQYJKoZIhvcNAQEBBQAEggEAJmDDYtpic27ujlyO34Ef
# 0bTw2+8rU6goYV+xiDuuh4D88PhilbJxlkgbRMdPd+YuFd3uOSL4l5yR0dfV108A
# AboUv/2JOY95ViGWpxveGw6FQEMpPqnuWwANOHsXB0Y2VII791KNMdOV+Dmos1PQ
# p3qdY1ZtrgKC9d3huunvUj3VL4z2dcS4UGsO6dPI7/UAHxJqhn9QlGCYRO9cQq3G
# o0KffVzeFtPQkuSrFwcOVVCrteNVqLTTaLl9YQzQxB2gVt1cCCXvNto/WMHp06cJ
# 2ZUykazWs4R8dePX1itqPGwLLR4rdhbv3EvBxOVjENvEXEVnHTavMd8gTbaz1QvS
# Y6GCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIBATByMF4xCzAJBgNVBAYTAlVT
...
# SIb3DQEJBTEPFw0xNjA1MTMxMzA4MDRaMCMGCSqGSIb3DQEJBDEWBBRE/Axl+0Aq
# gtYrS2n1MY8OKHsJ0TANBgkqhkiG9w0BAQEFAASCAQBzC14yQtEOOw6Lv+Xz3jgb
# EY/LNqfG/NWYJIrdjx4Uk65rojmzH/8ziRgP5qqWcHH1K7Sv4yy6+GJm5iODZ/iv
# ffwAwvRx4oyZ3zOLCVziFrqOYBTOGZTyaEIuE6b4EFR9XbAUjoOMLSHSJe1sNMbn
# T7LMdJLEp5VJhtKu44Ak5ASNT22kUfBGm3sEhKeg52GBmoDTvtxzc9d7izmaVRnG
# f+FbYcJdq5pUaQ01fMcPY6A4EvYU3RIcI4MRbk580SQuPqXo9nw624IshSbgPKQB
# RaDBa5rEdlqoAnCnU8c/SYDdYZq5x2nnewe++5lf/1LoXVFiKsj3BVlXcThNg3A4
